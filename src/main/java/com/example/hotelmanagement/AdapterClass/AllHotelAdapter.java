package com.example.hotelmanagement.AdapterClass;
...
public class AllHotelAdapter extends FirebaseRecyclerAdapter<Hotel, AllHotelAdapter.myviewholder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull AllHotelAdapter.myviewholder holder, @SuppressLint("RecyclerView") int position, @NonNull Hotel model) {
    ...
    @NonNull
    @Override
    public AllHotelAdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
